...
this.unhighlightCategory = function(categoryName) {
switch(categoryName) { 
    case "BASICSCIENCES":
       var CHEM103TraditionalPlanelement = document.getElementById("CHEM103TraditionalPlan");
